...
<html lang="es">
                ...
                <form name="form21" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" style="">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input type="text" name="firstname" placeholder="Nombre" style="background-color: #FDD" value="<?php if (!$aErrores['firstname']) {
                echo $aFormulario['firstname'];
            } ?>"/>
                            <?php
                            if ($aErrores['firstname'] != NULL) {
                        ...
                        <div>
                            ...
                            <input type="text" name="firstnameOpc" placeholder="Nombre" value="<?php if (!$aErrores['firstnameOpc']) {
                                echo $aFormulario['firstnameOpc'];
                            } ?>"/>
    <?php
    if ($aErrores['firstnameOpc'] != NULL) {
    ...
    ?> 
                        ...
                        <div>
                            ...
                            <input type="text" name="lastname" placeholder="Apellido" style="background-color: #FDD" value="<?php if (!$aErrores['lastname']) {
                            echo $aFormulario['lastname'];
                        } ?>">
    <?php
    if ($aErrores['lastname'] != NULL) {
    ...
    ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="lastnameOpc" placeholder="Apellido" value="<?php if (!$aErrores['lastnameOpc']) {
        echo $aFormulario['lastnameOpc'];
    } ?>">
    <?php
    if ($aErrores['lastnameOpc'] != NULL) {
    ...
    ?>
                        ...
                        <div>
                            ...
                            <input type="radio" name="opcionRadio" value="opcion1" <?php if (is_null($aFormulario['opcionRadio'])) {
        echo "checked";
    } ?>> Opcion1
                        ...
                        <div>
                            ...
                            <input type="tel" name="opcionTel" placeholder="654987321" value="<?php if (!$aErrores['opcionTel']) {
        echo $aFormulario['opcionTel'];
    } ?>">
    <?php
    if ($aErrores['opcionTel'] != NULL) {
    ...
    ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" placeholder="prueba@prueba.com" style="background-color: #FDD" value="<?php if (!$aErrores['email']) {
        echo $aFormulario['email'];
    } ?>">
    <?php
    ...
    ?>
                        ...
                        <div>
                            ...
                            <input type='password' name='psw' style='background-color: #FDD' value="<?php if (!$aErrores['psw']) {
        echo $aFormulario['psw'];
    } ?>"><br>
    <?php
    if ($aErrores['psw'] != NULL) {
