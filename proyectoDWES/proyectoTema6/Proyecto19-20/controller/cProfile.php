...
if (isset($_SESSION['usuarioDAW2051920'])) {
    if (isset($_POST['btnModifyUser'])) {
        ...
        if ($entradaOK) {
            ...
            UsuarioPDO::modificar1Usuario($_SESSION['usuarioDAW2051920']->getCod_usuario(), $_SESSION['usuarioDAW2051920']->getTipo_usuario(), $name, $lname, $email);
    ...
    $aUsuarios = UsuarioPDO::buscarUsuario($_SESSION['usuarioDAW2051920']->getCod_usuario());
//var_dump($aArticulos);
    ...
    $_SESSION['vista'] = $vistas['profile']; //Se carga en la sesión de vistas, la que queremos
