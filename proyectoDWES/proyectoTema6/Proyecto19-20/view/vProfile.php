...
<div class="content">
   <form name="logIn" action="<?php echo $_SERVER['PHP_SELF']."?pag=profile&cod=".$aUsuario[0] ?>" method="post" enctype="multipart/form-data">
        <fieldset> 
            <h2>Profile User</h2>
            ...
            <select name="typeUser" id="typeUser" disabled>
                <?php if($aUsuario[1]==="admin"){
