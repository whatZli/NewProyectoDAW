...
<html lang="es">
    <head>
        ...
        <script src="../webroot/js/jquery-3.4.1.js"></script>
                ...
                <article id="a1">
                    <form name="logIn" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombreUsuario" name="loginUsuario" class="form-control" id="loginUsuario" aria-describedby="loginUsuario" placeholder="Introduce usuario">
                        </div>
                        <div class="form-group">
                        ...
                        ?>
                        <input  style="position:relative;left:-60px;" type="checkbox" id="Recordarme" name="Recordarme" value="Recordarme" />
                        <label  style="position:relative;left:-100px;" for="Recordarme">Recordarme el usuario</label>
                        <button type="submit" id="inicioSesion" name="iniciarSesion" class="btn btn-primary">Iniciar Sesión</button>
